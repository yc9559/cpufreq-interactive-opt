...
{
	lock_value "0:[powersave_l_input_boost_freq] 2:[powersave_b_input_boost_freq]" /sys/module/cpu_boost/parameters/input_boost_freq
}

function balance_custom()
{
	lock_value "0:[balance_l_input_boost_freq] 2:[balance_b_input_boost_freq]" /sys/module/cpu_boost/parameters/input_boost_freq
}

function performance_custom()
{
	lock_value "0:[performance_l_input_boost_freq] 2:[performance_b_input_boost_freq]" /sys/module/cpu_boost/parameters/input_boost_freq
}
