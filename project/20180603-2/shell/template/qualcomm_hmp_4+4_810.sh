...
function runonce_custom()
{
	...
	set_value 98 /proc/sys/kernel/sched_upmigrate

	# add some magic
	lock_value 4 /sys/devices/system/cpu/cpu4/core_ctl/min_cpus
	lock_value 4 /sys/devices/system/cpu/cpu4/core_ctl/max_cpus
	lock_value 0 /sys/devices/system/cpu/cpu4/core_ctl/min_cpus
	lock_value 2 /sys/devices/system/cpu/cpu4/core_ctl/max_cpus

	lock_value "0:1344000 4:1440000" /sys/module/msm_performance/parameters/cpu_max_freq
	lock_value 1344000 /sys/devices/system/cpu/cpu0/cpufreq/scaling_max_freq
	lock_value 1440000 /sys/devices/system/cpu/cpu4/cpufreq/scaling_max_freq
	...
	set_param_big use_sched_load [use_sched_load]
	lock_value [ignore_hispeed_on_notif] ${C1_GOVERNOR_DIR}/ignore_hispeed_on_notif
	lock_value [enable_prediction] ${C1_GOVERNOR_DIR}/enable_prediction
}
...
{
	lock_value "0:[powersave_l_input_boost_freq] 4:[powersave_b_input_boost_freq]" /sys/module/cpu_boost/parameters/input_boost_freq
}

function balance_custom()
{
	lock_value "0:[balance_l_input_boost_freq] 4:[balance_b_input_boost_freq]" /sys/module/cpu_boost/parameters/input_boost_freq
}

function performance_custom()
{
	lock_value "0:[performance_l_input_boost_freq] 4:[performance_b_input_boost_freq]" /sys/module/cpu_boost/parameters/input_boost_freq
}
