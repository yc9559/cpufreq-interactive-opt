...
function before_modify()
{
	...
	lock_value [uni_min_freq] /sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq
	lock_value [uni_min_freq] /sys/devices/system/cpu/cpu1/cpufreq/scaling_min_freq
	lock_value [uni_min_freq] /sys/devices/system/cpu/cpu2/cpufreq/scaling_min_freq
	lock_value [uni_min_freq] /sys/devices/system/cpu/cpu3/cpufreq/scaling_min_freq
}
...
{
	lock_value "[powersave_uni_input_boost_freq]" /sys/module/cpu_boost/parameters/input_boost_freq
}

function balance_custom()
{
	lock_value "[balance_uni_input_boost_freq]" /sys/module/cpu_boost/parameters/input_boost_freq
}

function performance_custom()
{
	lock_value "[performance_uni_input_boost_freq]" /sys/module/cpu_boost/parameters/input_boost_freq
}
