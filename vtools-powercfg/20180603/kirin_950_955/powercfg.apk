...
# Author: yc9559
# Platform: kirin_950_955
# Generated at: Thu Jun 28 00:11:29 2018
...
function verify_param() 
{
	...
	if [ "$action" = "powersave" ]; then
		expected_value="80 780000:62 980000:71 1280000:77 1480000:98"
	elif [ "$action" = "balance" ]; then
		expected_value="80 780000:69 980000:76 1280000:80 1480000:96"
	elif [ "$action" = "performance" ]; then
		expected_value="80 780000:66 980000:17 1280000:81 1480000:96 1780000:87"
...
if [ "$action" = "debug" ]; then
	...
	echo "Author: yc9559"
	echo "Platform: kirin_950_955"
	echo "Generated at: Thu Jun 28 00:11:29 2018"
	echo ""
...
if [ "$action" = "fast" ]; then
	...
	lock_value 1180000 ${C1_CPUFREQ_DIR}/scaling_min_freq
