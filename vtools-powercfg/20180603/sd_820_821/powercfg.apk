...
# Author: yc9559
# Platform: sd_820_821
# Generated at: Wed Jun 27 23:36:04 2018
...
function verify_param() 
{
	...
	if [ "$action" = "powersave" ]; then
		expected_value="80 380000:5 580000:42 680000:60 780000:70 880000:83 980000:92 1180000:97"
	elif [ "$action" = "balance" ]; then
		expected_value="80 380000:9 580000:36 780000:62 880000:71 980000:87 1080000:75 1180000:98"
	elif [ "$action" = "performance" ]; then
		expected_value="80 380000:7 480000:31 580000:13 680000:58 780000:63 980000:73 1180000:98"
...
if [ "$action" = "debug" ]; then
	...
	echo "Author: yc9559"
	echo "Platform: sd_820_821"
	echo "Generated at: Wed Jun 27 23:36:04 2018"
	echo ""
...
if [ "$action" = "fast" ]; then
	fast_custom
	lock_value 1080000 ${C0_CPUFREQ_DIR}/scaling_min_freq
