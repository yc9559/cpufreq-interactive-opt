...
# Author: yc9559
# Platform: sd_625_626
# Generated at: Thu Jun 28 01:59:58 2018
...
{
	lock_value "0:980000" /sys/module/cpu_boost/parameters/input_boost_freq
}
...
function verify_param() 
{
	...
	if [ "$action" = "powersave" ]; then
		expected_value="80 980000:66 1380000:96"
	elif [ "$action" = "balance" ]; then
		expected_value="80 980000:63 1380000:72 1680000:97"
	elif [ "$action" = "performance" ]; then
		expected_value="80 980000:55 1380000:75 1680000:98"
...
if [ "$action" = "debug" ]; then
	...
	echo "Author: yc9559"
	echo "Platform: sd_625_626"
	echo "Generated at: Thu Jun 28 01:59:58 2018"
	echo ""
