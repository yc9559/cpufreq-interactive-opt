...
# Author: yc9559
# Platform: atom_z3560_z3580
# Generated at: Thu Jun 28 05:59:09 2018
...
function verify_param() 
{
	...
	if [ "$action" = "powersave" ]; then
		expected_value="80 580000:56 680000:44 780000:33 880000:48 980000:62 1080000:74 1280000:89 1480000:98"
	elif [ "$action" = "balance" ]; then
		expected_value="80 580000:53 680000:38 880000:49 980000:60 1180000:65 1280000:82 1380000:63 1480000:97"
	elif [ "$action" = "performance" ]; then
		expected_value="80 580000:59 680000:36 780000:75 880000:39 1080000:56 1380000:52 1480000:57 1580000:97"
...
if [ "$action" = "debug" ]; then
	...
	echo "Author: yc9559"
	echo "Platform: atom_z3560_z3580"
	echo "Generated at: Thu Jun 28 05:59:09 2018"
	echo ""
...
if [ "$action" = "fast" ]; then
	fast_custom
	lock_value 1380000 ${C0_CPUFREQ_DIR}/scaling_min_freq
