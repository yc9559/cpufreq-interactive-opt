...
# Author: yc9559
# Platform: helio_x10
# Generated at: Thu Jun 28 06:33:16 2018
...
function powersave_custom()
{
	...
	lock_value 2 /proc/hps/num_base_perf_serv
}

function balance_custom()
{
	lock_value 80 /proc/hps/up_threshold
	lock_value 3 /proc/hps/num_base_perf_serv
}
...
function fast_custom()
{
	...
	lock_value 4 /proc/hps/num_base_perf_serv
}
...
function verify_param() 
{
	...
	if [ "$action" = "powersave" ]; then
		expected_value="80 780000:51 1180000:65 1280000:83 1480000:98"
	elif [ "$action" = "balance" ]; then
		expected_value="80 780000:60 1180000:86 1280000:79 1480000:97"
	elif [ "$action" = "performance" ]; then
		expected_value="80 780000:61 1180000:65 1280000:83 1480000:63 1580000:96"
...
if [ "$action" = "debug" ]; then
	...
	echo "Author: yc9559"
	echo "Platform: helio_x10"
	echo "Generated at: Thu Jun 28 06:33:16 2018"
	echo ""
