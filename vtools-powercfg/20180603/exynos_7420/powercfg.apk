...
# Author: yc9559
# Platform: exynos_7420
# Generated at: Thu Jun 28 05:27:01 2018
...
function before_modify()
{
	...
	lock_value 780000 ${C1_CPUFREQ_DIR}/scaling_min_freq
}
...
function verify_param() 
{
	...
	if [ "$action" = "powersave" ]; then
		expected_value="80 480000:28 580000:19 680000:37 780000:51 880000:61 1080000:83 1180000:66 1280000:91 1380000:96"
	elif [ "$action" = "balance" ]; then
		expected_value="80 480000:29 580000:12 680000:69 780000:22 880000:36 1080000:80 1180000:89 1480000:63"
	elif [ "$action" = "performance" ]; then
		expected_value="80 480000:26 580000:32 680000:69 780000:50 880000:15 1080000:80 1180000:85 1480000:56"
	elif [ "$action" = "fast" ]; then
		expected_value="80 1480000:90"
	fi
...
if [ "$action" = "debug" ]; then
	...
	echo "Author: yc9559"
	echo "Platform: exynos_7420"
	echo "Generated at: Thu Jun 28 05:27:01 2018"
	echo ""
