...
# Author: yc9559
# Platform: sd_810_808
# Generated at: Sat Jul 14 16:45:37 2018
...
{
	lock_value "0:580000 4:480000" /sys/module/cpu_boost/parameters/input_boost_freq
}
...
function verify_param() 
{
	...
	if [ "$action" = "powersave" ]; then
		expected_value="80 580000:27 680000:48 780000:68 880000:82 1180000:98"
	elif [ "$action" = "balance" ]; then
		expected_value="80 580000:59 680000:54 780000:63 880000:85 1180000:98 1280000:94"
	elif [ "$action" = "performance" ]; then
		expected_value="80 580000:63 680000:54 780000:60 880000:32 1180000:98 1280000:93"
	elif [ "$action" = "fast" ]; then
		expected_value="80 1280000:90"
	fi
...
if [ "$action" = "debug" ]; then
	...
	echo "Author: yc9559"
	echo "Platform: sd_810_808"
	echo "Generated at: Sat Jul 14 16:45:37 2018"
	echo ""
...
if [ "$action" = "fast" ]; then
	fast_custom
	lock_value 880000 ${C0_CPUFREQ_DIR}/scaling_min_freq
	...
	set_param_little min_sample_time 38000
	lock_value 880000 ${C1_CPUFREQ_DIR}/scaling_min_freq
